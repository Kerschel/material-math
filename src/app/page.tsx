      ...
      <section className="bg-gradient-to-b from-green-50 to-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 tracking-tight">
            Instant Material Calculators
            <br />
            <span className="text-green-600">for Your Next Project</span>
          </h1>
          <p className="mt-6 text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
            Enter your project dimensions and instantly get how much mulch, soil, gravel, concrete,
            or any material you need — plus cost estimates.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="space-y-3">
              ...
              <p className="text-sm text-gray-600">
                Measure your project area and enter the length, width, and desired depth into the
                calculator.
              </p>
            </div>
            <div className="space-y-3">
              ...
              <h3 className="font-semibold text-gray-800">2. See Results</h3>
              <p className="text-sm text-gray-600">
                Get instant results in cubic yards, tons, bags, or whatever unit your supplier uses
            ...
            <div className="space-y-3">
              ...
              <h3 className="font-semibold text-gray-800">3. Shop Confidently</h3>
              <p className="text-sm text-gray-600">
                Order exactly what you need — no more guessing, no expensive over-ordering, and no
      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
        <article className="prose prose-green max-w-none">
          ...
          <p>
            ...
            pouring a concrete patio, or building a deck, knowing exactly how much material you need
            saves time, money, and frustration. Our calculators use proven formulas and national
            average pricing data to give you accurate, actionable estimates.
          </p>
          <p>
            ...
            Every tool also includes a detailed cost estimate based on current national average
            prices.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>Instant results</strong> — no loading spinners, no page refreshes, no sign-up
              required.
            </li>
            <li>
            ...
            <li>
              <strong>Programmatic SEO pages</strong> — pre-calculated results for common project
              sizes like 4&prime;×8&prime; garden beds and 12&prime;×12&prime; patios.
            </li>
          </ul>
        </article>
      </section>
